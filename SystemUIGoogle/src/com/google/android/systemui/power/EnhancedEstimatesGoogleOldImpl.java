...
@SysUISingleton
public class EnhancedEstimatesGoogleOldImpl implements EnhancedEstimates {

    private static final String TAG = "EnhancedEstimatesGoogleOldImpl";

    private Context mContext;
    private final KeyValueListParser mParser = new KeyValueListParser(',');

    @Inject
    public EnhancedEstimatesGoogleOldImpl(Context context) {
        mContext = context;
    }
